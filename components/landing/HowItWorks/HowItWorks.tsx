    ...
    <>
      ...
      >
        <div className="mx-auto max-w-7xl px-6 py-20 sm:py-24 lg:px-8 lg:py-28">
          ...
          {/* Steps */}
          <div className="relative mt-16 grid gap-6 md:grid-cols-3 md:gap-8 lg:mt-20">
            ...
            {steps.map((step) => (
              <div
                key={step.number}
                className="relative rounded-2xl border border-border bg-background p-7 transition-shadow hover:shadow-sm sm:p-8"
              >
                {/* Step number */}
